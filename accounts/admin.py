...
class UserAccountAdmin(admin.ModelAdmin):
    list_display = ['id', 'is_superuser', 'is_staff', 'email', 'name', 'surname', 'membership', 'is_active', 'is_verified', 'is_company', 'is_leader', 'is_member']
...
class TeamAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'name', 'occupied_places', 'places', 'creation_date', 'completion_date']
